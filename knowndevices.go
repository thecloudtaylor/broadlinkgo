...
var knownDevices = []KnownDevice{
	...
	KnownDevice{DeviceType: 0x5213, Name: "Broadlink RM4 Pro", Supported: true, Ir: true, Rf: true, Power: false, RequestHeader: []byte{0x04, 0x00}, CodeSendingHeader: []byte{0xd0, 0x00}},
